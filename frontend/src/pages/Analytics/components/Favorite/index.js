...
import useMonitoringFavoriteInEventsQuery from './hooks/useMonitoringFavoriteInEventsQuery'
import useFavoriteNormalize from './hooks/useFavoriteNormalize'
...
const Favorite = () => {
	const {
		...
		data,
		error
	} = useMonitoringFavoriteInEventsQuery()

	const dataNormalize = useFavoriteNormalize(data)
						...
						<EuiFlexGroup gutterSize="xs" direction="column">
							...
							<EuiFlexItem>
								<EuiText
									...
									style={null}
								>
									Аналитика активности мероприятий по заинтересованности участников
								</EuiText>
							</EuiFlexItem>
						</EuiFlexGroup>
					</EuiFlexItem>
